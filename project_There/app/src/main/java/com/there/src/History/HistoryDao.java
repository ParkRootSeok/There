...
*/
    ...
    //!-- ethan
    // 게시물 생성함수
    public int insertPost(PostHistoryReq postHistoryReq){
        String insertPostQuery = "INSERT INTO Post(userIdx, imgUrl, content) VALUES (?, ?, ?)";
        Object []insertPostParams = new Object[] {postHistoryReq.getUserIdx(), postHistoryReq.getImgUrl(), postHistoryReq.getContent()};
